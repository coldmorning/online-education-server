...
public enum ResultCode {
    ...
    ERROR_Login(ResultHttpStatus.status401,1001,"登入失敗"),

    SUCESS_Register(ResultHttpStatus.status201,0010,"註冊成功"),
    ERROR_Register_Exist(ResultHttpStatus.status422,1011,"註冊失敗, 帳號已存在"),
    ERROR_Register_RePassword(ResultHttpStatus.status400,1012,"註冊失敗, 兩次輸入密碼不同"),
